...
The directory structure for the application and its documentation is as follows:
    ...
    Design_Pattern_Quiz/
          â”œâ”€ doc/                        Folder produced by RDoc.
          â”œâ”€ img/                        Folder for the documentation's image files.
          â””â”€ src/                        Folder for the application's source code.
               â”œâ”€ public/                Folder for the server's public documents.
               â”‚       â””â”€ images/      Folder for the application's images.
               â”œâ”€ models/                Folder for the application's models.
               â””â”€ views/                 Folder for the application's views (ERB files).
               â””â”€ functions/             Folder for the application's microservices functions.
